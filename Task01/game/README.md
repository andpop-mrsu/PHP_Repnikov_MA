...
1. Клонируйте репозиторий:
   ```bash
   git clone https://github.com/Neospaer/game.git
   cd Game_name
...
2. Установите игру:
    ```bash
    composer global require neospaer/prime_php_repnikov_ma_dv
...
## Ссылки
- Packagist: [Prime Game](https://packagist.org/packages/neospaer/prime_php_repnikov_ma_dv)
- [Репозиторий на GitHub](https://github.com/Neospaer/game.git)
- Автор: repnikovMA
- Лицензия: MIT
